...
requireText('homepage', 'blocking checks in every consumer', 'consumer-owned blocking checks');
requireText('homepage', 'blocking validation across every consumer', 'consumer-owned blocking validation');
